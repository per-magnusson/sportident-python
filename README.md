...
## Install
For Windows, [you will need a driver to talk to BSM7/8 USB stations](https://www.sportident.com/products/usb-driver).
The newer BS11 stations are currently not supported by sportident-python.
